...
export declare class CanvasRenderer {
    ...
    private readonly surfaceBudget;
    canvas: HTMLCanvasElement;
    ...
    private legacySubtree;
    constructor(context: Context, options: RenderConfigurations, surfaceRoot?: ElementPaint | undefined, surfaceBudget?: SurfaceBudget);
    renderStack(stack: StackingContext): Promise<void>;
    private canComposite;
    private renderCompositedStack;
    ...
    private renderSurfaceBoxShadow;
     ...
     */
    private renderTextClippedBackground;
    /**
