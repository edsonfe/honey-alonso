...
class ElementPaint {
    ...
    getEffects(target, surfaceRoot) {
        ...
        const sourceEffects = (paint) => paint.effects.filter((effect) => paint !== surfaceRoot || (!(0, effects_1.isFilterEffect)(effect) && !(0, effects_1.isOpacityEffect)(effect)));
        const effects = sourceEffects(this);
        while (parent) {
            const croplessEffects = sourceEffects(parent).filter((effect) => !(0, effects_1.isClipEffect)(effect));
