...
const renderFilterArgs = (values) => {
    ...
    for (const v of values) {
        ...
        if (v.type === 18 /* TokenType.FUNCTION */) {
            parts.push(`${v.name}(${renderFilterArgs(v.values)})`);
        }
        else if (v.type === 4 /* TokenType.COMMA_TOKEN */) {
            parts.push(',');
        }
        else if (v.type === 6 /* TokenType.DELIM_TOKEN */) {
            parts.push(v.value);
        }
        else if (v.type === 15 /* TokenType.DIMENSION_TOKEN */) {
